...
from acgan_pytorch.utils import create_folder
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="An implementation of ACGAN algorithm using PyTorch framework.")
    parser.add_argument("data", metavar="DIR",
                        help="path to dataset")
    parser.add_argument("--dataset", type=str, required=True,
                        help="| imagenet |.")
    parser.add_argument("-a", "--arch", metavar="ARCH", default="imagenet",
                        choices=model_names,
    ...
    parser.add_argument("--num-classes", type=int, default=100,
                        help="Number of classes for dataset. (default: 100).")
